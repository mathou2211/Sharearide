...
<!-- method = get post -->
    ...
    <div class="container-center">
        <div class="border border-secondary rounded" style="padding: 20px 30px;">
...
<input class="form-control w-50"
       ...
       required />
            ...
            <input class="form-control w-50" type="tel" id="phone" name="phone" pattern="[0-9]{12}" placeholder="0123456789" required />
        </div>
        ...
        <div class="d-flex flex-column m-3">
            ...
            <input class="btn-check" type="radio" name="r" id="ja" value="yes" checked>
            ...
            <input class="btn-check" id="other" type="radio" name="r" value="maybe">
